...
#ifndef NODE_REGISTRY_HPP_
#define NODE_REGISTRY_HPP_
...
public:
  ...
  std::optional<unique_identifier_msgs::msg::UUID> deregister_node(const std::string & name);
